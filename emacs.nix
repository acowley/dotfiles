  ...
  myEmacsPackageOverrides = self: super: super.melpaPackages // {
    ...
    lsp-mode = super.melpaBuild {
      ...
      src = nixpkgs.fetchFromGitHub {
        owner = "emacs-lsp";
        repo = "lsp-mode";
        rev = "c1f310cb589db13236e1bfccd986bbba92c7138e";
        sha256 = "1liv3hnhirwrv76j5yy5wdxwsr1q0g9kpfypvhcjcx6ckgcjxdng";
      };
      recipe = nixpkgs.fetchurl {
    ...
    lsp-ui = super.melpaBuild {
      ...
      src = nixpkgs.fetchFromGitHub {
        owner = "emacs-lsp";
        repo = "lsp-ui";
        rev = "1592f108bcfd6533f3148feb49057a759837f838";
        sha256 = "18yvac0587b0n6q6bp9wia9i93vh6qbbkkvdyqagjnsp7dd4hv6r";
      };
      recipe = nixpkgs.fetchurl {
  ...
  myEmacsPackagesNg =
    ...
    # else nixpkgs.emacsPackagesNgGen (nixpkgs.emacs.override { inherit (nixpkgs) imagemagick; });
      ...
      src = nixpkgs.fetchgit {
        ...
        sha256 = "1lhcfnc9na98clhxszfllladnp3y5sq2g3zkbpmawsfss8pd8mvc";
      };
      patches = [];
      prePatch = ''
